...
<div class="container mx-auto px-4 py-6" >
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Crear Metadatos SEO</h1>
    </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="page_slug" name="page_slug" value="{{ old('page_slug') }}" 
                        ...
                        <div>
                            ...
                            <select id="language_code" name="language_code"
                                ...
                                <option value="es" @if(old('language_code', 'es') == 'es') selected @endif>Español (es)</option>
                                <option value="en" @if(old('language_code') == 'en') selected @endif>Inglés (en)</option>
                                <option value="pt" @if(old('language_code') == 'pt') selected @endif>Portugués (pt)</option>
                            </select>
                            @error('language_code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3"
                                class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('meta_description') border-red-500 @else border-gray-300 @enderror">{{ old('meta_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_robots" name="meta_robots" value="{{ old('meta_robots', 'index, follow') }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="og_type" name="og_type"
                                ...
                                <option value="website" @if(old('og_type', 'website') == 'website') selected @endif>website</option>
                                <option value="article" @if(old('og_type') == 'article') selected @endif>article</option>
                                <option value="product" @if(old('og_type') == 'product') selected @endif>product</option>
                            </select>
                            @error('og_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="og_description" name="og_description" rows="3"
                                class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('og_description') border-red-500 @else border-gray-300 @enderror">{{ old('og_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="url" id="og_url" name="og_url" value="{{ old('og_url') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="og_site_name" name="og_site_name" value="{{ old('og_site_name') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="og_locale" name="og_locale" value="{{ old('og_locale', 'es_CO') }}" 
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Tamaño recomendado: 1200x630 píxeles</p>
                            @error('og_image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="twitter_card" name="twitter_card"
                                ...
                                <option value="summary_large_image" @if(old('twitter_card', 'summary_large_image') == 'summary_large_image') selected @endif>summary_large_image</option>
                                <option value="summary" @if(old('twitter_card') == 'summary') selected @endif>summary</option>
                                <option value="app" @if(old('twitter_card') == 'app') selected @endif>app</option>
                            </select>
                            @error('twitter_card')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="twitter_description" name="twitter_description" rows="3"
                                class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('twitter_description') border-red-500 @else border-gray-300 @enderror">{{ old('twitter_description') }}</textarea>
                            <p class="mt-1 text-xs text-gray-500">Si se deja vacío, se usará la meta descripción</p>
                        ...
                        <div>
                            ...
                            <input type="text" id="twitter_site" name="twitter_site" value="{{ old('twitter_site') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="twitter_creator" name="twitter_creator" value="{{ old('twitter_creator') }}" 
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Tamaño recomendado: 1200x600 píxeles</p>
                            @error('twitter_image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="twitter_image_alt" name="twitter_image_alt" value="{{ old('twitter_image_alt') }}" 
